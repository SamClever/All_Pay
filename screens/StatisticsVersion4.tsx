...
import { AnalyticsMonthV4, AnalyticsQuarterV4, AnalyticsYearToYearV4, AnalyticsYearV4 } from '../tabs';
...
const renderScene = SceneMap({
  first: AnalyticsMonthV4,
  second: AnalyticsQuarterV4,
  third: AnalyticsYearV4,
  fourth: AnalyticsYearToYearV4
});
...
export default StatisticsVersion4