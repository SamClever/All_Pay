import { View, Text, StyleSheet, ScrollView, Alert, TouchableOpacity, Modal, TouchableWithoutFeedback, FlatList, TextInput, Image, ImageSourcePropType, Platform } from 'react-native';
          ...
          <View style={[styles.inputContainer, { backgroundColor: dark ? COLORS.dark2 : COLORS.greyscale500 }]}>
            <TouchableOpacity
              ...
              <View style={{ justifyContent: "center" }}>
                <Image
                  source={icons.down as ImageSourcePropType}
                  resizeMode='contain'
