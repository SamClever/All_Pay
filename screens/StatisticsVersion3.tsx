...
import { AnalyticsMonthV3, AnalyticsQuarterV3, AnalyticsYearToYearV3, AnalyticsYearV3 } from '../tabs';
...
const renderScene = SceneMap({
  first: AnalyticsMonthV3,
  second: AnalyticsQuarterV3,
  third: AnalyticsYearV3,
  fourth: AnalyticsYearToYearV3
});
...
export default StatisticsVersion3