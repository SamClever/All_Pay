...
const data = [
    ...
    { name: 'Feb', income: 25002, expense: 10000 },
    { name: 'Mar', income: 10000, expense: 20000 },
    { name: 'Apr', income: 24000, expense: 25000 },
    { name: 'May', income: 30000, expense: 12000 },
    { name: 'Jun', income: 30000, expense: 2000 },
];

const AnalyticsQuarterV2 = () => {
    const { dark } = useTheme();
...
export default AnalyticsQuarterV2