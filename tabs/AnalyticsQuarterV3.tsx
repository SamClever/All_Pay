...
const pieData = [
    { name: 'Income', population: 22000, color: '#246BFD', legendFontColor: '#7F7F7F', legendFontSize: 15 },
    { name: 'Expense', population: 32100, color: '#FF5252', legendFontColor: '#7F7F7F', legendFontSize: 15 },
];

const AnalyticsQuarterV3 = () => {
    const { dark } = useTheme();
...
export default AnalyticsQuarterV3