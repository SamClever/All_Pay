import { View, Text, TouchableOpacity, StyleSheet, Dimensions, ImageSourcePropType, Image } from 'react-native';
...
const pieData = [
    { name: 'Income', population: 232000, color: '#246BFD', legendFontColor: '#7F7F7F', legendFontSize: 15 },
    { name: 'Expense', population: 132100, color: '#FF5252', legendFontColor: '#7F7F7F', legendFontSize: 15 },
];

const AnalyticsYearToYearV3 = () => {
    const { dark } = useTheme();
...
export default AnalyticsYearToYearV3