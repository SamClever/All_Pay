...
const pieData = [
    { name: 'Income', population: 1132000, color: '#246BFD', legendFontColor: '#7F7F7F', legendFontSize: 15 },
    { name: 'Expense', population: 332100, color: '#FF5252', legendFontColor: '#7F7F7F', legendFontSize: 15 },
];

const AnalyticsYearV3 = () => {
    const { dark } = useTheme();
...
export default AnalyticsYearV3