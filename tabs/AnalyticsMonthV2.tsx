...
const data = [
    { name: '23', income: 2000, expense: 1500 },
    { name: '24', income: 2500, expense: 1800 },
    { name: '25', income: 3000, expense: 2000 },
    { name: '26', income: 4000, expense: 2500 },
    { name: '27', income: 3500, expense: 2300 },
    { name: '28', income: 3000, expense: 200 },
];

const AnalyticsMonthV2 = () => {
    const { dark } = useTheme();
...
export default AnalyticsMonthV2