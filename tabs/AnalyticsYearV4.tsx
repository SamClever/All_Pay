...
const data = [
    { name: 'Jan', income: 33000, expense: 12000 },
    { name: 'Feb', income: 2000, expense: 1300 },
    { name: 'Mar', income: 39000, expense: 32001 },
    { name: 'Apr', income: 30002, expense: 25009 },
    { name: 'May', income: 8900, expense: 23000 },
];

const AnalyticsYearV4 = () => {
    const { dark } = useTheme();
...
export default AnalyticsYearV4