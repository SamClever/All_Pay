import { View, Text, StyleSheet, TouchableOpacity, Dimensions, ImageSourcePropType, Image } from 'react-native';
...
const data = [
    { name: '22', income: 2000, expense: 1500 },
    { name: '23', income: 2500, expense: 1800 },
    { name: '24', income: 3000, expense: 2000 },
    { name: '25', income: 4000, expense: 2500 },
    { name: '26', income: 3500, expense: 2300 },
];

const AnalyticsMonthV4 = () => {
    const { dark } = useTheme();
...
export default AnalyticsMonthV4